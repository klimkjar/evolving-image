...
var imageEvolver = (function () {
  ...
  lib.Point = function (owner, source) {
    var self = this;
  ...
  //          created.
  lib.Polygon = (function () {
    var Point = lib.Point;
    var Colour = lib.Colour;
  ...
  lib.PolygonImage = (function () {
    var Colour = lib.Colour;
    var Polygon = lib.Polygon;
  ...
  //            evolution process
  lib.ImageEvolver = function (source, infoCallback) {
    var PolygonImage = lib.PolygonImage;
